...
<head>
    ...
    <title>Resumablejs + Laravel Chunk Upload (Meta Sistem test task)</title>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-footer p-4" style="display: none">
                    ...
                    -->
                    <div id="filePreview" style="width: 100%; height: auto; display: none"></div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    resumable.on('fileSuccess', function (file, response) { // trigger when file upload complete
        ...
        $('#filePreview').html('<a href="' + response.path + '/' + response.name + '" download>' + response.path + '/' + response.name + '</a>').show();
